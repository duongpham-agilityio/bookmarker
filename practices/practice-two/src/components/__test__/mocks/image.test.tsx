...
jest.mock('assets/icons/calendar.svg', () => ({
  default: 'assets/icons/calendar.svg',
}));
...
// Mock images
jest.mock('assets/icons/agility.png', () => ({
  default: 'assets/icons/agility.png',
}));

jest.mock('assets/icons/Logo.jpg', () => ({
